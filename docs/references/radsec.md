...
Arista C-200 series (except the C-250/C-260), O-200 series, and C-300 series have a TPM chip which contains the required certificate used for RadSec. However, if the TPM chip does not exist, CV-CUE supports Custom Certificate Management for Access Points. 
