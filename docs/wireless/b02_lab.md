...
Click +Add Guest Portal




In the Configuration tab, provide the portal name (A/B-Portal) 
Leave the Authentication Type as Clickthrough.
Click the Customization tab to customize the portal settings, and notice the elements. 
Page
Login Toggle
